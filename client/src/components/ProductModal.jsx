...
export default function ProductModal({ product, onClose }) {
  ...
  const gallery = product.images?.length ? product.images : [product.image || fallbackImage]
